...
#include "ManiaTrackOffroadCar.h"
#include "ManiaTrackOffroadWheelFront.h"
#include "ManiaTrackOffroadWheelRear.h"
...
AManiaTrackOffroadCar::AManiaTrackOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UManiaTrackOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UManiaTrackOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UManiaTrackOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UManiaTrackOffroadWheelRear::StaticClass();
