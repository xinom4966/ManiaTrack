...
#include "ManiaTrackSportsCar.h"
#include "ManiaTrackSportsWheelFront.h"
#include "ManiaTrackSportsWheelRear.h"
...
AManiaTrackSportsCar::AManiaTrackSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UManiaTrackSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UManiaTrackSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UManiaTrackSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UManiaTrackSportsWheelRear::StaticClass();
